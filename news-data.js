(function (root) {
  ...
  root.AmazonNewsData = [
    ...
    },
    {
      ...
      sellerImpact: ['使用 Featured Offer 的卖家', '多卖家竞争 Listing'], actionRequired: 'none',
    ...
    },
    {
      ...
      sellerImpact: ['非媒体类目卖家', '标题超过 75 字符的 Listing', '品牌所有者'], actionRequired: 'review',
    ...
    },
    {
      ...
      sellerImpact: ['已加入 Brand Registry 的品牌', '需要处理侵权或违规的卖家'], actionRequired: 'info',
    ...
    },
    {
      ...
      sellerImpact: ['新卖家', '卖家运营与支持团队'], actionRequired: 'info',
    ...
    },
    {
      ...
      sellerImpact: ['通过移动设备管理业务的卖家'], actionRequired: 'info',
    ...
    },
    {
      ...
      sellerImpact: ['加拿大站 FBA 卖家', '使用 Amazon 预处理或贴标服务的入库流程', 'SP-API 集成商'], actionRequired: 'required',
    ...
    },
    {
      ...
      sellerImpact: ['使用 Amazon VAT Calculation Service 的欧盟卖家', '处理波兰电子发票数据的团队', '税务报告集成商'], actionRequired: 'review',
